...
class CategoryTranslations extends Collection<CategoryTranslation> {
  ...
  CategoryTranslations copyWithConfigs(Configs? configs) {
    return CategoryTranslations(this.manager.copyWith(configs: configs));
  }

  @override
  CategoryTranslation singleModelFromMap(Map<String, dynamic> map) {
    return CategoryTranslation.fromMap(map["categorytranslation"]);
  }
