...
class Products extends Collection<Product> {
  ...
  Products copyWithConfigs(Configs? configs) {
    return Products(this.manager.copyWith(configs: configs));
  }

  @override
  Product singleModelFromMap(Map<String, dynamic> map) {
    return Product.fromMap(map["product"]);
  }
