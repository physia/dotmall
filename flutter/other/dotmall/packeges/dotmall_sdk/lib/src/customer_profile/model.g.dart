...
class CustomerProfiles extends Collection<CustomerProfile> {
  ...
  CustomerProfiles copyWithConfigs(Configs? configs) {
    return CustomerProfiles(this.manager.copyWith(configs: configs));
  }

  @override
  CustomerProfile singleModelFromMap(Map<String, dynamic> map) {
    return CustomerProfile.fromMap(map["customerprofile"]);
  }
