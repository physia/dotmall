...
class StoreTranslations extends Collection<StoreTranslation> {
  ...
  StoreTranslations copyWithConfigs(Configs? configs) {
    return StoreTranslations(this.manager.copyWith(configs: configs));
  }

  @override
  StoreTranslation singleModelFromMap(Map<String, dynamic> map) {
    return StoreTranslation.fromMap(map["storetranslation"]);
  }
