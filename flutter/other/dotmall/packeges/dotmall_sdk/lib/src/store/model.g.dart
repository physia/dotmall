...
class Stores extends Collection<Store> {
  ...
  Stores copyWithConfigs(Configs? configs) {
    return Stores(this.manager.copyWith(configs: configs));
  }

  @override
  Store singleModelFromMap(Map<String, dynamic> map) {
    return Store.fromMap(map["store"]);
  }
