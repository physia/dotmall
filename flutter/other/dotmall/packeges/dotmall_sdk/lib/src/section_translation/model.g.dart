...
class SectionTranslations extends Collection<SectionTranslation> {
  ...
  SectionTranslations copyWithConfigs(Configs? configs) {
    return SectionTranslations(this.manager.copyWith(configs: configs));
  }

  @override
  SectionTranslation singleModelFromMap(Map<String, dynamic> map) {
    return SectionTranslation.fromMap(map["sectiontranslation"]);
  }
