...
import 'parts/account_part.dart';
import 'parts/orders_part.dart';
import 'parts/settings_part.dart';
          ...
          child: Column(
            children: [
              ...
              CollectionListPanel<Categories, Category>(
                collection:
                    Categories(Manager(context.read<HomeBloc>().configs)),
                ...
                itemBuilder: (context, panel, model, state) {
                  return CategoryCard(
                      ...
                      onPressed: model == null
                          ? null
                          : () {
                        context.beamToNamed("/categories/${model.id}");
                            },
                      model: model);
                },
              ),
